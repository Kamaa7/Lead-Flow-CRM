...
const aiFeatures = [
  { name: 'AI Chatbot', href: '/ai-chat', icon: ChatBubbleLeftRightIcon },
  { name: 'Lead Scoring', href: '/ai-scoring', icon: RocketLaunchIcon },
  { name: 'Smart Insights', href: '/ai-insights', icon: LightBulbIcon },
  { name: 'Auto-Responders', href: '/ai-responses', icon: SparklesIcon },
];

const quickActions = [
  { name: 'Add Lead', href: '/leads/new', icon: UserGroupIcon },
  { name: 'Add Property', href: '/properties/new', icon: BuildingOfficeIcon },
  { name: 'Schedule Task', href: '/tasks/new', icon: CalendarDaysIcon },
  { name: 'Send Email', href: '/email-center/compose', icon: EnvelopeIcon },
];
          ...
          <div className="mt-2 space-y-1">
            {quickActions.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-gray-700 hover:bg-gray-100 hover:text-gray-900 group flex items-center px-3 py-2 text-sm font-medium rounded-l-md transition-colors duration-200"
              >
                <item.icon
